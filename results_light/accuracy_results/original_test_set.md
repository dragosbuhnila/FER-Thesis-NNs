...
(e models-py3.11) PS C:\Users\Dragos\Roba\Lectures\YM2.2\Thesis\e Models> & "C:/Users/Dragos/Roba/Lectures/YM2.2/Thesis/e Models/.venv/Scripts/python.exe" "c:/Users/Dragos/Roba/Lectures/YM2.2/Thesis/e Models/evaluate_model.py"
2025-10-15 18:38:57.733360: I tensorflow/core/util/port.cc:113] oneDNN custom operations are on. You may see slightly different numerical results due to floating-point round-off errors from different computation orders. To turn them off, set the environment variable `TF_ENABLE_ONEDNN_OPTS=0`.
WARNING:tensorflow:From C:\Users\Dragos\Roba\Lectures\YM2.2\Thesis\e Models\.venv\Lib\site-packages\keras\src\losses.py:2976: The name tf.losses.sparse_softmax_cross_entropy is deprecated. Please use tf.compat.v1.losses.sparse_softmax_cross_entropy instead.
...
2025-10-15 18:39:09.242016: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
To enable the following instructions: SSE SSE2 SSE3 SSE4.1 SSE4.2 AVX2 FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.
WARNING:tensorflow:From C:\Users\Dragos\Roba\Lectures\YM2.2\Thesis\e Models\.venv\Lib\site-packages\keras\src\engine\functional.py:156: The name tf.executing_eagerly_outside_functions is deprecated. Please use tf.compat.v1.executing_eagerly_outside_functions instead.
...
6/6 [==============================] - 5s 528ms/step - loss: 0.1281 - categorical_accuracy: 0.7400
======================================
Evaluating model: pattlite_finetuning
6/6 [==============================] - 2s 133ms/step - loss: 0.1164 - categorical_accuracy: 0.7600
======================================
Evaluating model: vgg19_finetuning
6/6 [==============================] - 15s 2s/step - loss: 0.1184 - categorical_accuracy: 0.7629
======================================
Evaluating model: inceptionv3_finetuning
6/6 [==============================] - 3s 233ms/step - loss: 0.1237 - categorical_accuracy: 0.7543
======================================
Evaluating model: convnext_finetuning
2025-10-15 18:40:35.910884: I external/local_xla/xla/service/service.cc:168] XLA service 0x18902580460 initialized for platform Host (this does not guarantee that XLA will be used). Devices:
2025-10-15 18:40:35.911160: I external/local_xla/xla/service/service.cc:176]   StreamExecutor device (0): Host, Default Version
WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
I0000 00:00:1760546436.727503   31488 device_compiler.h:186] Compiled cluster using XLA!  This line is logged at most once for the lifetime of the process.
2025-10-15 18:40:36.733967: E external/local_xla\xla/stream_executor/stream_executor_internal.h:177] SetPriority unimplemented for this stream.
6/6 [==============================] - 157s 25s/step - loss: 0.1226 - categorical_accuracy: 0.7829
======================================
Final evaluation results on occluded test set:
Model: resnet_finetuning - Test Loss: 0.1281, Test Accuracy: 0.7400
Model: pattlite_finetuning - Test Loss: 0.1164, Test Accuracy: 0.7600
