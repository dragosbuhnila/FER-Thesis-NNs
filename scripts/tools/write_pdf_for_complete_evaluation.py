...
# Filepath: c:\Users\Dragos\Roba\Lectures\YM2.2\Thesis\e Models\results_light\saved_images\20260220-164405_cmplt-run_occft-models_occluded-testset_do-evaluation-completely-keras


def create_pdf(output_path, base_folder):
    # Initialize the PDF
    ...
    agreement_folder = os.path.join(base_folder, "agreement_analysis")
    ...
    model_folders = [f for f in os.listdir(base_folder) if f.startswith("occft_")]
...
def add_csv_to_pdf(csv_path, elements, max_rows=30, max_columns=8):
...
# Example usage:
# & C:/Users/Dragos/.conda/envs/fer-thesis/python.exe "c:/Users/Dragos/Roba/Lectures/YM2.2/Thesis/e Models/scripts/tools/write_pdf_for_complete_evaluation.py" --folder_name 20260220-164405_cmplt-run_occft-models_occluded-testset_do-evaluation-completely-keras
if __name__ == "__main__":
    # BASE_FOLDER = r"c:\Users\Dragos\Roba\Lectures\YM2.2\Thesis\e Models\results_light\saved_images\20260220-164405_cmplt-run_occft-models_occluded-testset_do-evaluation-completely-keras"
    create_pdf(OUTPUT_PATH, BASE_FOLDER)
